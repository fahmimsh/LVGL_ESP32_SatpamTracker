...
void setup_scr_screen_Menu(lv_ui *ui){
	...
	lv_label_set_text(ui->screen_Menu_bat_status, "0%");
	...
	lv_obj_set_size(ui->screen_Menu_bat_status, 51, 0);

	//Write codes screen_Menu_label_tanggal
	ui->screen_Menu_label_tanggal = lv_label_create(ui->screen_Menu, NULL);
	lv_label_set_text(ui->screen_Menu_label_tanggal, "12 Juni 2021");
	...
	lv_label_set_text(ui->screen_Menu_label_jam, "18:06");
