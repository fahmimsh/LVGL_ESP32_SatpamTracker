...
void setup_scr_screen_menu_ruangan(lv_ui *ui){
	...
	lv_label_set_text(ui->screen_menu_ruangan_bat_status, "%");
	...
	lv_obj_set_size(ui->screen_menu_ruangan_bat_status, 100, 0);
	...
	lv_label_set_text(ui->screen_menu_ruangan_label_tanggal, "");
	...
	lv_label_set_text(ui->screen_menu_ruangan_label_jam, "");
