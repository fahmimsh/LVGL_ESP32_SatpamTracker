...
void setup_scr_screen_set_wifi(lv_ui *ui){
	...
	lv_label_set_text(ui->screen_set_wifi_bat_status, "0%");
	...
	lv_obj_set_size(ui->screen_set_wifi_bat_status, 51, 0);
	...
	lv_label_set_text(ui->screen_set_wifi_label_tanggal, "12 Juni 2021");
	...
	lv_label_set_text(ui->screen_set_wifi_label_jam, "18:06");
